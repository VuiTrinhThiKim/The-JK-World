        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a a onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này?')" href="{{URL::to('/admin/category/delete/'.$cate_item->category_id)}}" class="delete-category" ui-toggle-class="">
